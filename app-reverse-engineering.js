...
function reKnownField(record,a,b,dat){
  ...
  if(label.startsWith('AHFX Manager')){
    const eng=reEngineId(record,dat),fields=eng==='1c03'?
      ...
      [[30,31,'Plate Pre Delay'],[36,37,'Plate Diffusion'],[38,39,'Plate Size'],[40,41,'Plate Shape'],[56,57,'Plate Decay'],[66,67,'Plate Modulation Speed'],[68,69,'Plate Modulation Depth'],[70,71,'Plate Output LF Cut'],[72,73,'Plate Output HF Cut'],[85,85,'Plate Type preset'],[112,113,'Plate Width'],[120,121,'Plate Position'],[131,131,'Plate Echoes section'],...[[1,'L1',0],[2,'R1',3],[3,'L2',1],[4,'R2',4],[5,'L3',2],[6,'R3',5]].flatMap(([n,tap,k])=>[[88+4*k,89+4*k,`Plate Echo ${n} (${tap}) Time`],[90+4*k,91+4*k,`Plate Echo ${n} (${tap}) Gain`],[133+2*k,133+2*k,`Plate Echo ${n} (${tap}) On/Off`]])]:[];
